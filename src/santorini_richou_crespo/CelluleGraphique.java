...
public class CelluleGraphique extends JButton {
    ...
    ImageIcon niveau1G = new javax.swing.ImageIcon(getClass().getResource("/images/niveau1G.jpg"));
    ImageIcon niveau1B = new javax.swing.ImageIcon(getClass().getResource("/images/niveau1B.jpg"));
   ...
   @Override
    public void paintComponent(Graphics G){
        ...
        else if (CelluleAssociee.etageCourant.niveauEtage==1 && CelluleAssociee.ouvrierCourant==null){
            setIcon(niveau1);
        }
